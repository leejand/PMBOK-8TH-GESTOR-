...
window.Gestor = (function () {
  ...
  var ROLES_PROYECTO = [
    { id: 'lider', nombre: 'Líder de proyecto', nivel: 'dirigir',
      alcance: 'Dirige: configuración, metodología, fases y equipo.' },
    { id: 'po', nombre: 'Product Owner', nivel: 'editar',
      alcance: 'Edita el proyecto: procesos, documentos, backlog y registros.' },
    { id: 'sm', nombre: 'Scrum Master', nivel: 'editar',
      alcance: 'Edita el proyecto, igual que el Product Owner.' },
    { id: 'equipo', nombre: 'Equipo de desarrollo', nivel: 'editar',
      alcance: 'Edita el proyecto, igual que el Product Owner.' },
    { id: 'ejecutor', nombre: 'Ejecutor', nivel: 'ejecutar',
      alcance: 'Ve y mueve solo sus tareas y conversa; no ve los planes.' },
    { id: 'observador', nombre: 'Observador', nivel: 'ver',
      alcance: 'Ve todo el proyecto y comenta; no cambia nada.' }
  ];
